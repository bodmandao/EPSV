...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `
    You are an AI vault assistant.
    Analyze the context below and provide insights about stored content.
    Include:
    - Summary of content relevance
    - Potential use or collaboration insights
    - Suggested title and tags
    - Any detected duplicate or redundant file suggestions
    ...
    console.error("Vault insights error:", err);
    return NextResponse.json(
